...
{
	// Above Sleep-statement is to prevent 'stopping Windows-shell' when terminating MFC program.
	// Thus, waiting to be terminated another thread-used by MFC-
	// 
	// Fucking MFC t(-_-t)   Written by Young man.
...
void CModelViewApp::OnSpecularSetting() 
{
	;
}
