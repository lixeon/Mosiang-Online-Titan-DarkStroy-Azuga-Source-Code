...
/*
	{	// BLOCK: doc template registration
		...
		CSingleDocTemplate* pNewDocTemplate = new CSingleDocTemplate(
			IDR_LEFTPANE_TMPL,
			RUNTIME_CLASS(CMy4DyuchiGXMapEditorDoc),		// document class
			RUNTIME_CLASS(CMainFrame),		// frame class
			RUNTIME_CLASS(CMy4DyuchiGXMapEditorView));		// view class
...
/*
	...
	{	// BLOCK: doc template registration
		...
		CSingleDocTemplate* pNewDocTemplate = new CSingleDocTemplate(
			...
			RUNTIME_CLASS(CMy4DyuchiGXMapEditorDoc),		// document class
			RUNTIME_CLASS(CMainFrame),		// frame class
			RUNTIME_CLASS(CBottomPane));		// view class
		AddDocTemplate(pNewDocTemplate);
	}
	...
	{	// BLOCK: doc template registration
		...
		CSingleDocTemplate* pNewDocTemplate = new CSingleDocTemplate(
			...
			RUNTIME_CLASS(CMy4DyuchiGXMapEditorDoc),		// document class
			RUNTIME_CLASS(CMainFrame),		// frame class
			RUNTIME_CLASS(CLeftPane));		// view class
		AddDocTemplate(pNewDocTemplate);
	}
*/
