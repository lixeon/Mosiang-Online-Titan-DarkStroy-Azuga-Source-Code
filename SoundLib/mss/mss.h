...
#define MSS_VERSION      "6.5e"
#define MSS_MAJOR_VERSION 6
#define MSS_MINOR_VERSION 5
#define MSS_SUB_VERSION   4
#define MSS_VERSION_DATE "17-Mar-03"

#define MSS_COPYRIGHT "Copyright (C) 1991-2003, RAD Game Tools, Inc."
...
//
  ...
  #define MSS_REDIST_DIR_NAME "WIN"
...
// JChow: why does the W32 build process complain about these three files at all?
//    #include <Files.h>
//    #include <Sound.h>
...
#define MSS_REDIST_DIR_NAME "LINUX"
#define MSSDLLNAME "Miles Shared Library"
...
#ifndef MAKEFOURCC
/* FIXME: this is the little endian version */
#define MAKEFOURCC(ch0, ch1, ch2, ch3)                              \
              ((U32)(U8)(ch0) | ((U32)(U8)(ch1) << 8) |   \
              ((U32)(U8)(ch2) << 16) | ((U32)(U8)(ch3) << 24 ))
#endif
