         ...
         LPVOID* ppv)
{
	...
	if (CLSID_DBTHREAD_DLL == rclsid)
	{
		hr = E_OUTOFMEMORY;
		pIFactory = new DBThreadFactory;
		if (pIFactory)
		{
...
STDAPI DllUnregisterServer(void)
{
  ...
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_DBTHREAD_DLL\\CurVer"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_DBTHREAD_DLL\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_DBTHREAD_DLL"));

  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_DBTHREAD_DLL.1\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_DBTHREAD_DLL.1"));
