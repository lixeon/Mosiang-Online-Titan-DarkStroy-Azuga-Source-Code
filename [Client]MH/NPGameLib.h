...
// Error Code  110 - 300
#define HOOK_TIMEOUT                   100         // Hooking failed (for virus, spyware etc..)
...
#define NPGAMEMON_ERROR_GAMEGUARD2     620         // GameGuard Init Error or bypass by Windows account

// etc
//??? 128 // unknown Windows XP x64 Beta ver. (not error code from GameGuard)

// Error Code  310 - 400
// Update Error Code
#define NPGMUP_ERROR_PARAM             320         // .ini not found
#define NPGMUP_ERROR_INIT              330         // npgmup.des Init Error
