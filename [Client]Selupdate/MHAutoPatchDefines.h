...
#define WM_RUN_ONOK				SAFETY_RANGE+3
...
//
#define MH_VERSION_INFO_FILE				"LauncherVerInfo.ver"
#define MH_VERSION_INFO_FINE_NEW			"LauncherVerInfo_New.ver"

//
#define SELF_UPDATE_FILE					"selupdate.exe"
#define LAUNCHER_FILE						"MHAutoPatch.exe"
//
...
char* const			g_szMHpatchFile		= "LAPatch.mhp";
