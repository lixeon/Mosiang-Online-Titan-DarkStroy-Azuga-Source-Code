<%@ Register TagPrefix="uc1" TagName="forgotpassword" Src="control/forgotpassword.ascx" %>
<%@ Page language="c#" Codebehind="forgetpassword.aspx.cs" AutoEventWireup="false" Inherits="web.forgetpassword" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellSpacing="0" cellPadding="0" width="956" border="0">
				<tr>
					...
					<td vAlign="top" width="775" align="center">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_forgetpassword.jpg" height="46"></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" height="600" align="center">
									<uc1:forgotpassword id="Forgotpassword1" runat="server"></uc1:forgotpassword>
								</td>
							</tr>
						</table>
					</td>
