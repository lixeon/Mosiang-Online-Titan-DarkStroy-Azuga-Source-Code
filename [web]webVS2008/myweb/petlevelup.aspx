...
<%@ Page language="c#" Codebehind="petlevelup.aspx.cs" AutoEventWireup="false" Inherits="web.petlevelup" %>
<%@ Register TagPrefix="uc1" TagName="petlevelup" Src="control/petlevelup.ascx" %>
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_petlvup.jpg" height="46"><FONT face="細明體"></FONT></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" height="600" align="center"><FONT face="宋体">
										<uc1:petlevelup id="Petlevelup1" runat="server"></uc1:petlevelup></FONT></td>
							</tr>
						</table>
					</td>
				</tr>
