<%@ Control Language="c#" AutoEventWireup="false" Codebehind="cpmenu.ascx.cs" Inherits="web.control.cpmenu" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script>
...
<table width="146" border="0" cellspacing="0" align="center" cellpadding="0" class="leftmenulist"
	...
	<tr class="leftmenutext" align="left">
		<td>
			<div align="left">
				<a href="../default.aspx" target="_blank"><b>網站首頁</b></a>&nbsp;&nbsp; <a href="serverinfo.aspx">
					<b>後台首頁</b></a>
			</div>
		</td>
	</tr>
