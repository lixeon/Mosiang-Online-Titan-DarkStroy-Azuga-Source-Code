<%@ Page language="c#" Codebehind="modifypassword.aspx.cs" AutoEventWireup="false" Inherits="web.modifypassword" %>
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_modifypassword.jpg" height="46"><FONT face="細明體"></FONT></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" height="600" align="center">
									<uc1:modifypassword id="Modifypassword1" runat="server"></uc1:modifypassword></td>
							</tr>
						</table>
					</td>
				</tr>
