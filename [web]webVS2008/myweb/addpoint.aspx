...
<%@ Page language="c#" Codebehind="addpoint.aspx.cs" AutoEventWireup="false" Inherits="web.addpoint" %>
<%@ Register TagPrefix="uc1" TagName="addpoint" Src="control/addpoint.ascx" %>
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_addpoint.jpg" height="46"><FONT face="細明體"></FONT></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" height="500" align="center"><FONT face="宋体">
										<uc1:addpoint id="Addpoint1" runat="server"></uc1:addpoint></FONT></td>
							</tr>
						</table>
					</td>
				</tr>
