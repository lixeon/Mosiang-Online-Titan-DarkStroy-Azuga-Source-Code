namespace web.admin
{
    ...
    public class cptoolsip : Page
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            ...
            new DataProviders().ExecuteSql("insert into TB_OPERIP (ipadress,ipregdate) values ('" + str + "',getdate())");
            base.Response.Redirect("cptoolsip.aspx");
        }
        ...
        private void btnedit_Click(object sender, EventArgs e)
        {
            ...
            string str = new system().ChkSql(this.tbip.Text.ToString());
            new DataProviders().ExecuteSql(string.Concat(new object[] { "update TB_OPERIP set ipadress='", str, "' where ipidx=", num }));
        ...
        private void DataGrid1_Delete(object sender, DataGridCommandEventArgs e)
        {
            ...
            new DataProviders().ExecuteSql("delete from TB_OPERIP where ipidx=" + num);
            base.Response.Redirect("cptoolsip.aspx");
        }
        ...
        private void DataGrid1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlDataReader reader = providers.ExecuteSqlDataReader("select * from TB_OPERIP where ipidx=" + num);
            if (reader.Read())
            {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.DataGrid1.DataSource = new DataProviders().ExecuteSqlDs("select * from TB_OPERIP", "DataGrid1");
