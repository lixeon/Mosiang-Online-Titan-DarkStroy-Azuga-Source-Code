namespace web.admin
{
    ...
    public class cpviewmember : Page
    {
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            sql = "select * from mhcmember..chr_log_info  where";
            string str9 = "";
            int num7 = 0;
            if (num != 0)
            {
            ...
            if (str2 != "")
            {
                if (num7 == 0)
                {
                    str9 = str9 + " userpassword like '%" + str2 + "%'";
                    num7++;
                }
                else
                {
                    str9 = str9 + " and userpassword like '%" + str2 + "%'";
                }
            }
            if (str5 != "")
            {
        ...
        {
            base.Response.Write("<script>window.open('cpviewcharacter.aspx?userid=" + this.tbuserid.Text.ToString() + "')</script>");
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.btnsearchcha.Click += new EventHandler(this.btnsearchcha_Click);
