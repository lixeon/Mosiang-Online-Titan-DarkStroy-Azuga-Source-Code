...
<%@ Page language="c#" Codebehind="modifychaname.aspx.cs" AutoEventWireup="false" Inherits="web.modifychaname" %>
<%@ Register TagPrefix="uc1" TagName="modifychaname" Src="control/modifychaname.ascx" %>
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_modifychaname.jpg" height="46"><FONT face="細明體"></FONT></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" height="500" align="center">
									<uc1:modifychaname id="Modifychaname1" runat="server"></uc1:modifychaname></td>
							</tr>
						</table>
					</td>
				</tr>
