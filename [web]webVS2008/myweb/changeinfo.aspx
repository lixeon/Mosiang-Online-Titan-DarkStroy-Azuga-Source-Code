<%@ Register TagPrefix="uc1" TagName="changeinfo" Src="control/changeinfo.ascx" %>
...
<%@ Page language="c#" Codebehind="changeinfo.aspx.cs" AutoEventWireup="false" Inherits="web.changeinfo" %>
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_changeinfo.jpg" height="46"><FONT face="細明體"></FONT></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" height="600" align="center"><FONT face="宋体">
										<uc1:changeinfo id="changeinfo1" runat="server"></uc1:changeinfo></FONT></td>
							</tr>
						</table>
					</td>
				</tr>
