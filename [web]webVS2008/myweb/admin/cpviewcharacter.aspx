...
<%@ Page language="c#" Codebehind="cpviewcharacter.aspx.cs" AutoEventWireup="false" Inherits="web.admin.cpviewcharacter" %>
											...
											<td vAlign="top" align="left">
												<TABLE id="Table4" style="WIDTH: 559px; HEIGHT: 768px" cellSpacing="1" cellPadding="1"
													...
													<TR>
														...
														<TD style="WIDTH: 55px; HEIGHT: 27px"><asp:button id="btnedit" runat="server" Text="修改角色信息" Enabled="False"></asp:button></TD>
													</TR>
													<TR>
