...
<%@ Page language="c#" Codebehind="cplog.aspx.cs" AutoEventWireup="false" Inherits="web.admin.cplog" %>
										...
										<tr bgColor="#efefef">
											<td vAlign="top" align="left">
												<TABLE id="Table4" style="WIDTH: 560px" cellSpacing="1" cellPadding="1" width="560" border="0">
													<TR>
														<TD style="WIDTH: 107px; HEIGHT: 36px" colSpan="2"><b>管理日誌明細</b></TD>
													</TR>
													<TR>
														<TD colSpan="2">
															<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" Width="552px" AllowPaging="True"
																...
																<Columns>
																	...
																	<asp:BoundColumn DataField="type" HeaderText="內容"></asp:BoundColumn>
																</Columns>
