...
<%@ Page language="c#" ValidateRequest="false" Codebehind="cpnotice.aspx.cs" AutoEventWireup="false" Inherits="web.admin.cpnotice" %>
										...
										<tr bgColor="#efefef">
											<td vAlign="top" align="left" height="350">
												<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="575" border="0" style="WIDTH: 575px; HEIGHT: 524px">
													<TR>
														<TD style="WIDTH: 107px; HEIGHT: 22px" colSpan="2"><b>公告管理</b></TD>
													</TR>
													<TR>
