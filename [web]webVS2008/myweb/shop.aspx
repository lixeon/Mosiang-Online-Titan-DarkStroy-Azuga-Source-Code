...
<%@ Page language="c#" Codebehind="shop.aspx.cs" AutoEventWireup="false" Inherits="web.shop" %>
<%@ Register TagPrefix="uc1" TagName="shop" Src="control/shop.ascx" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775"  bgcolor=ffffff>
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_shop.jpg" height="46"><FONT face="宋体"></FONT></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" align="center" height="550">
									<uc1:shop id="Shop1" runat="server"></uc1:shop></td>
							</tr>
						</table>
					</td>
				</tr>
