...
<%@ Page language="c#" Codebehind="register.aspx.cs" AutoEventWireup="false" Inherits="web.register" %>
			...
			<table cellSpacing="0" cellPadding="0" width="956" align="left" border="0">
				<tr>
					...
					<td vAlign="top" width="775">
						<table>
							<tr>
								<td align="center" width="775" background="images/top_line_register.jpg" height=46></td>
							</tr>
							<tr>
								<td vAlign="top" width="775" background="images/bg_logincol.gif" align=center height="550" >
